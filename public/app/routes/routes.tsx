...
import { AccessControlAction, DashboardRoutes, DashboardRouteInfo } from 'app/types';
  ...
  return [
    {
      ...
      routeName: DashboardRoutes.Overview,
      component: SafeDynamicImport(() => import(/* webpackChunkName: "DashboardPage" */ '../features/overview')),
    },
    {
      path: '/team',
      pageClass: 'page-overview',
    ...
    },
    {
      ...
      routeName: DashboardRoutes.Normal,
      component: SafeDynamicImport(
        () => import(/* webpackChunkName: "ManageViewPage" */ '../features/analytics/ManageView')
      ),
    },
    {
    ...
    {
      path: '/managedashboards/importdashboard',
      pageClass: 'page-dashboard',
      routeName: DashboardRoutes.Normal,
      component: SafeDynamicImport(() => import('../features/custom-manage-dashboards/import-dashboard')),
    },
    {
      path: '/taskmanager',
      pageClass: 'page-taskmanager',
      routeName: DashboardRoutes.Normal,
      component: SafeDynamicImport(() => import(/* webpackChunkName: "TaskManager" */ '../features/task-manager')),
    },
    {
      path: '/taskmanager/alltasks',
      pageClass: 'page-taskmanager',
      routeName: DashboardRoutes.Normal,
      component: SafeDynamicImport(
        () => import(/* webpackChunkName: "TaskManager" */ '../features/task-manager/all-tasks')
      ),
    },
    {
      path: '/taskmanager/create-dashboard',
      pageClass: 'page-taskmanager',
      routeName: DashboardRoutes.Normal,
      component: SafeDynamicImport(
        () => import(/* webpackChunkName: "TaskManager" */ '../features/task-manager/create-dashboard')
      ),
    },
    {
      ...
      routeName: DashboardRoutes.Normal,
      component: SafeDynamicImport(
        () => import(/* webpackChunkName: "DashboardPage" */ '../features/custom-manage-dashboards')
      ),
    },
    {
      path: '/eks-explorer',
    ...
    },
    {
      ...
      routeName: DashboardRouteInfo.Normal,
      component: SafeDynamicImport(
        () => import(/* webpackChunkName: "DashboardPage" */ '../features/just-dashboard-json')
      ),
    },
    // {
    //   path: '/',
    ...
    },
    {
      path: '/dashboardlist',
      component: SafeDynamicImport(
        () => import(/* webpackChunkName: "DashboardImport"*/ 'app/features/custom-dashboard-list')
      ),
    },
    {
      path: '/datasources',
