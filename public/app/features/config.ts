const securitySrvUrl = `http://3.208.22.155:8094/`;
const alertSrvUrl = `http://3.208.22.155:5055`;
const catalogSrvUrl = `http://3.208.22.155:5050/api/`;
const previewUrl = 'http://3.208.22.155:5057/api';
