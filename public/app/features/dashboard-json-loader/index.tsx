...
// Redux
import { initDashboardFromJson } from './initDashboardFromJson';
...
export interface Props {
  ...
  initDashboardFromJson: typeof initDashboardFromJson;
...
class DashboardJSONLoader extends PureComponent<any, State> {
  state: State = {
    editPanel: null,
    viewPanel: null,
  ...
  async componentDidMount() {
    this.props.initDashboardFromJson({
      $injector: this.props.$injector,
      $scope: this.props.$scope,
      urlSlug: this.props.slug,
  ...
  render() {
    const { dashboard, editview, isInitSlow, initError, inspectTab } = this.props;
...
export default hot(module)(connect(mapStateToProps, mapDispatchToProps)(DashboardJSONLoader));
