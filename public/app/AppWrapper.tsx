...
import { CustomSideMenu } from "./core/components/NavBar/CustomSideMenu";
import { CustomNavigationBar } from "./core/components/CustomNav";
                      ...
                      <main className="main-view">
                        ...
                        <div
                          className={
                            location.pathname && location.pathname == "/login"
                              ? ""
                              : "scroll-canvas--dashboard monitor-main-body"
                          }
                        >
