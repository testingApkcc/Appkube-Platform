export const catalogData = {
  ...
  ops: {
    cloudDashBoards: [
      ...
      {
        id: 8,
        name: 'Azure-Active-Directory-Data',
        description: 'Azure Active Directory Operations',
        associatedDataSourceType: 'Azure-PullLog-Api',
        associatedDataType: 'LOG',
        associatedSLAType: 'PERFORMANCE',
      ...
      {
        id: 8,
        name: 'Java-Spring-Boot-Trace',
        description: 'Java Spring Boot App Tracer',
        associatedDataSourceType: 'App-Trace',
        associatedDataType: 'TRACE',
        associatedSLAType: 'RELIABILITY',
        associatedCloud: 'OTHER',
        associatedCloudElementType: 'JAVA-APP',
        jsonLocation:
          's3://synectiks-monitoring-dashboards/Azure Dashboards/Azure Active Directory/Azure Active Directory - Overview.json',
      },
      {
        id: 8,
        name: 'NodeJs-UI-Trace',
        description: 'NODEJS App Tracer',
        associatedDataSourceType: 'App-Trace',
        associatedDataType: 'TRACE',
        associatedSLAType: 'END-USER-STATS',
        associatedCloud: 'OTHER',
        associatedCloudElementType: 'NODE-APP',
        jsonLocation:
          's3://synectiks-monitoring-dashboards/Azure Dashboards/Azure Active Directory/Azure Active Directory - Overview.json',
      },
    ],
