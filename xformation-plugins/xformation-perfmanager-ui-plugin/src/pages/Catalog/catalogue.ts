  ...
  ops: {
    cloudDashBoards: [
      ...
      },
      {
        ...
        images: ['https://syn-monitoring-images.s3.amazonaws.com/AWS-Images/EC2/EC2-Overview.png'],
      },
      {
        id: 84,
        ...
        images: ["https://syn-monitoring-images.s3.amazonaws.com/AWS-Images/EC2/EC2-AMI-And-Ip's.png"],
      },
      {
        id: 85,
        ...
        images: ['https://syn-monitoring-images.s3.amazonaws.com/AWS-Images/EC2/Target-And-Security-Group.png'],
      },
      {
        id: 86,
      ...
      },
      {
        ...
        images: ['https://syn-monitoring-images.s3.amazonaws.com/AWS-Images/EC2/Disk-read-writes-by-instanceID.png'],
      },
      {
        id: 88,
        ...
        images: ['https://syn-monitoring-images.s3.amazonaws.com/AWS-Images/EC2/Network-packets-in-and-out.png'],
      },
      {
        id: 89,
        ...
        images: ['https://syn-monitoring-images.s3.amazonaws.com/AWS-Images/API-Gateway/Overview.png'],
      },
      {
        id: 90,
      ...
      },
      {
        ...
        images: ['https://syn-monitoring-images.s3.amazonaws.com/AWS-Images/API-Gateway/4xx-5xx-Errors.png'],
      },
      {
        id: 92,
        ...
        images: ['https://syn-monitoring-images.s3.amazonaws.com/AWS-Images/API-Gateway/Enhanced-Monitoring.png'],
      },
      {
        id: 93,
      ...
      },
      {
        ...
        images: ['https://syn-monitoring-images.s3.amazonaws.com/Azure-Images/SQL/Timeouts.png'],
      },
      {
        id: 14,
