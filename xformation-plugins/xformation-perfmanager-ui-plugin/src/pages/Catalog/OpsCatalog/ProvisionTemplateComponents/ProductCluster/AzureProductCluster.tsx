...
export class AzureProductCluster extends React.Component<any, any>{
            ...
            return (
                <div className="catalogue-right-container">
                    <div className="contents">
                        <strong>Create new Product Cluster with DevSecOps best practice in Azure</strong>
                        <h3>Product Cluster</h3>
                        <p>The command will package and deploy your application to Azure, with a series of prompts</p>
                        <h3>Prerequisites</h3>
                        <p><strong>Region:</strong> Azure region code for creating resources</p>
                        ...
                        <p><strong>Vault User:</strong> The Azure IAM Username whose credentials will be used to authenticate the Vault pods against Azure</p>
                        ...
                        <p><strong>Fargate Profile:</strong> With Azure Fargate, you don't have to provision, configure, or scale groups of virtual machines on your own to run Pods</p>
