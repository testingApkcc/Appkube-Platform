...
export class AzureProductEnclave extends React.Component<any, any>{
        ...
        if (activeTab === 0) {
            return (
                <div className="catalogue-right-container">
                    ...
                    <div className="contents">
                        <strong>Create new Product Enclave with DevSecOps best practice in Azure</strong>
                        <h3>Product Enclave</h3>
                        <p>The command will package and deploy your application to Azure, with a series of prompts</p>
                        <h3>Prerequisites</h3>
                        <p><strong>Product Enclave:</strong> The command will package and deploy your application to Azure, with a series of prompts</p>
            ...
            return (
                <div className="catalogue-right-container">
                    <button onClick={() => this.props.showMainView()} className="contents-close"><i className="fa fa-close"></i></button>
                    <div className="contents">
                        <strong> Create new Product Enclave with DevSecOps practice in Azure</strong>
                        <h3>Product Enclave</h3>
                        <p>The command will package and deploy your application to Azure, with a series of prompts</p>
