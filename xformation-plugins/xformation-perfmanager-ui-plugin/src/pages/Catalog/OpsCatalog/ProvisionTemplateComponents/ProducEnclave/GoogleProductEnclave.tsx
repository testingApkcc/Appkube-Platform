...
export class GoogleProductEnclave extends React.Component<any, any>{
    ...
    formFields = () => {
        ...
        if (activeTab === 0) {
            return (
                <div className="catalogue-right-container">
                    <div className="contents">
                        <strong>Create new Product Enclave with DevSecOps best practice in Google</strong>
                        <h3>Product Enclave</h3>
                        <p>The command will package and deploy your application to Google, with a series of prompts</p>
                        <h3>Prerequisites</h3>
                        <p><strong>Product Enclave:</strong> The command will package and deploy your application to Google, with a series of prompts</p>
            ...
            return (
                <div className="catalogue-right-container">
                    <div className="contents">
                        <strong> Create new Product Enclave with DevSecOps practice in Google</strong>
                        <h3>Product Enclave</h3>
                        <p>The command will package and deploy your application to Google, with a series of prompts</p>
