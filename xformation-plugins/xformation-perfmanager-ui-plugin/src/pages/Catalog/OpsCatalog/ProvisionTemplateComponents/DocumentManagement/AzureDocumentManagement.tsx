...
export class AzureDocumentManagement extends React.Component<any, any>{
            ...
            return (
                <div className="catalogue-right-container">
                    ...
                    <div className="contents">
                        <strong>Document Management System with DevSecOps best practice in Azure</strong>
                        ...
                        <p><strong>Azure Region:</strong> The Azure region you want to deploy your app to use</p>
                        ...
                        <p><strong>Confirm changes before deploy:</strong> If set to yes, any change sets will be shown to you before execution for manual review; if set to no, the Azure SAM CLI will automatically deploy application changes</p>
                        <p><strong>Allow SAM CLI IAM role creation:</strong> FormKiQ Core’s Azure SAM templates create Azure IAM roles required for the Azure Lambda function(s) included to access Azure services; the permissions are passed in by the sam deploy command  above, so this value should be set to "Y" </p>
            ...
            return (
                <div className="catalogue-right-container">
                    ...
                    <div className="contents">
                        <strong>Document Management System with DevSecOps best practice in Azure</strong>
                        <h3>Document Management System</h3>
                        <p>This Command will package and deploy your application to Azure, with a series of prompts</p>
