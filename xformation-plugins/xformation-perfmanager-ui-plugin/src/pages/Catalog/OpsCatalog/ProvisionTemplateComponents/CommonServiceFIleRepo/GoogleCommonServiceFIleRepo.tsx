...
export class GoogleCommonServiceFIleRepo extends React.Component<any, any>{
    ...
    validate = (isSubmitted: any) => {
        ...
        if (isSubmitted) {
            const { stackName, googleRegion, adminEmail, appEnvironment, enablePublicURLs, passwordMinimumLength, passwordRequresLowercase, passwordRequresNumber, passwordRequresSymbols, passwordRequresUppercase, confirmChangeBefore, allowSAMCLIIAMRoleCreation, saveArgumentTosamconfig } = this.state;
            if (!stackName) {
                retData.stackName = {
                    isValid: false,
    ...
    handleSubmit = (event: any) => {
        ...
        if (errorData.isValid) {
            const { stackName, googleRegion, adminEmail, appEnvironment, enablePublicURLs, passwordMinimumLength, passwordRequresLowercase, passwordRequresNumber, passwordRequresSymbols, passwordRequresUppercase, confirmChangeBefore, allowSAMCLIIAMRoleCreation, saveArgumentTosamconfig } = this.state;
            localStorage.setItem('viewData', JSON.stringify({ stackName, googleRegion, adminEmail, appEnvironment, enablePublicURLs, passwordMinimumLength, passwordRequresLowercase, passwordRequresNumber, passwordRequresSymbols, passwordRequresUppercase, confirmChangeBefore, allowSAMCLIIAMRoleCreation, saveArgumentTosamconfig }));
        }
    };
    ...
    formFields = () => {
        ...
        if (activeTab === 0) {
            return (
                <div className="catalogue-right-container">
                    ...
                    <div className="contents">
                        <strong>Common Service File Repo with DevSecOps best practice in Google</strong>
            ...
            const { stackName, googleRegion, adminEmail, appEnvironment, enablePublicURLs, passwordMinimumLength, passwordRequresLowercase, passwordRequresNumber, passwordRequresSymbols, passwordRequresUppercase, confirmChangeBefore, allowSAMCLIIAMRoleCreation, saveArgumentTosamconfig, isSubmitted } = this.state;
                        ...
                        <div className="form-detail-group">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={this.handleStateChange}
                                />
                                {errorData && !errorData.isValid && <span className="error">{errorData.googleRegion.message}</span>}
                            </div>
                            <div className="form-group">
