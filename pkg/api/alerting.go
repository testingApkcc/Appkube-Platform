...
// func GetAlertNotificationByName(c *models.ReqContext) response.Response {
// 	query := &models.GetAlertNotificationsWithNameQuery{
// 		OrgId: c.OrgId,
// 		Name:  web.Params(c.Req)[":name"],
// 	}

// 	if query.Name == "" {
// 		return response.Error(404, "Alert notification by name not found", nil)
// 	}

// 	if err := bus.Dispatch(query); err != nil {
// 		return response.Error(500, "Failed to get alert notification by name", err)
// 	}
